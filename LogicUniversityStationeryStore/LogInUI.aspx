...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div style="width:500px; margin:250px auto; padding:20px 0; text-align:left;background-color:#998fc4">
    &nbsp;&nbsp;<asp:Label ID="Label2" runat="server" Text="User Email" style="font-weight: 700; color: #FFFFFF"></asp:Label>
    <br/>&nbsp;&nbsp;<asp:TextBox ID="boxEmail" runat="server"></asp:TextBox>
    ...
    <br/>&nbsp;&nbsp;<asp:TextBox ID="boxPass" runat="server" TextMode="Password" EnableTheming="True"></asp:TextBox>
